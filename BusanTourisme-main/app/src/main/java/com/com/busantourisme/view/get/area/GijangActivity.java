...
public class GijangActivity extends AppBarActivity implements InitMethod {

    private static final String TAG = "GijangActivity";

    //다른 클래스에 메모리 전달
    private Context mContext = GijangActivity.this;
