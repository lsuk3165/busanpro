...
public class JinguActivity extends AppBarActivity implements InitMethod {

    private static final String TAG = "JinguActivity";

    //다른 클래스에 메모리 전달
    private Context mContext = JinguActivity.this;
